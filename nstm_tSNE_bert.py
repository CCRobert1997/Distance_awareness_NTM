...
def run_ntsm(args):
    ...
    save_dir = os.path.join(base_dir, 'save', 'dataset%s_K%d_RW%0.3f_RS%d_L%0.3fberttSNEW%0.3f' %
    ...
    with open('datasets/' + FLAGS.dataset + '/train_bert_embedding.pickle', 'rb') as handle:
